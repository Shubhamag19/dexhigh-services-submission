...
class OrderBookAll extends React.Component {
  constructor(props) {
    super(props);
                ...
                return (
                  <div className="ask flex align-items-center" key={price.toString()}>
                    <div className="col-6 orderbook-amount text-right">
                      ...
                      <div style={{ position: 'absolute', zIndex: 1, backgroundColor: 'rgba(255, 0, 0, 0.4)', left: '0px', top: '3px', height: '15px', width: `${amount / 100}%` }}></div>
                    </div>
                ...
                return (
                  <div className="bid flex align-items-center" key={price.toString()}>
                    <div className="col-6 orderbook-amount text-right">
                      ...
                      <div style={{ position: 'absolute', zIndex: 1, backgroundColor: 'rgba(0,255,0,0.4)', left: '0px', top: '3px', height: '15px', width: `${amount / 100}%` }}></div>
                    </div>
                    <div className="col-6 text-success text-right">
...
export default connect(mapStateToProps)(OrderBookAll);
